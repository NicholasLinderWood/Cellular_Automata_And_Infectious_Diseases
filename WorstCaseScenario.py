''' This script runs the "worst-case" scenario of a disease spreading through the country of
    Elbonia. The worst-case scenario is when the people of the country move around in a
    "well-mixed" type manner.
