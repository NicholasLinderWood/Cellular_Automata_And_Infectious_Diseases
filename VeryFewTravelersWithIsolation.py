...
#Add 225 susceptible persons to the country who move drunkenly
for i in range(225):
    country.Add_Person('S', MoveType = 'Drunkard')

#Add 225 susceptible persons to the country who isolate.
for i in range(225):
    country.Add_Person('S', MoveType = 'Isolate')

#Add 50 susceptible persons who move randomly
for i in range(50):
